      ...
      <div class="col-xl-9">
        ...
        <div class="card" style="border-radius: 15px;">
          <div class="card-body">
            ...
            <div class="px-5 py-4">
              <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" name="change_password_user" id="btn_change">Change Password</button>
            </div>
